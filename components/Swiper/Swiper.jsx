    ...
    return (
        <>
            ...
            >
                ...
                <SwiperSlide className={styles.carrousel__slide}>
                    <div>
                    <img src="../../assets/images/skills/sequelize.png" alt="" className={styles.carrousel__img} />
                        <h6 className={styles.carrousel__titulo}>Sequelize</h6>
                        <p className={styles.carrousel__descricao}>
                        Utilizando o Sequelize, gerencio de forma eficiente bancos de dados relacionais em minhas aplicações. Modelando dados de maneira consistente, garanto integridade e confiabilidade nos sistemas que desenvolvo.
                        </p>
                    </div>
                </SwiperSlide>
                ...
                <SwiperSlide className={styles.carrousel__slide}>
                    <div>
                    <img src="../../assets/images/skills/npm.svg" alt="" className={styles.carrousel__img}  />
                        <h6 className={styles.carrousel__titulo}>NPM</h6>
                        <p className={styles.carrousel__descricao}>
                        Como usuário experiente do NPM, gerencio eficazmente as dependências de meus projetos. Utilizo pacotes npm para otimizar o desenvolvimento, garantindo um ecossistema eficiente e seguro para minhas aplicações.
                        </p>
                    </div>
                </SwiperSlide>
            </Swiper>
